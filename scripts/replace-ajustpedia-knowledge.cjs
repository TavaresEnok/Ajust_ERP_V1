...
const ARTICLES = [
  ...
  article('Huawei - Criar VLAN', ['huawei', 'vlan', 'l2'], 'criar uma nova VLAN', [
    'vlan <ID_VLAN>',
  ]),
  article(
  ...
  article(
    ...
    [
      ...
      ' port trunk allow-pass vlan <LISTA_DE_VLANS>',
    ],
  ),
  article(
  ...
  article('Huawei MPLS - Ver peers LDP', ['huawei', 'mpls', 'ldp'], 'listar vizinhos LDP ativos', [
