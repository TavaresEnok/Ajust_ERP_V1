...
function applyTheme(mode: ThemeMode) {
  ...
  document.documentElement.classList.toggle('dark', mode === 'dark-blue');
...
function ThemeToneSwatches({
  ...
  return (
    <div
      className={cn(
        'inline-flex items-center gap-1 rounded-md border border-blue-300/30 bg-blue-500/10 p-1',
        compact && 'p-[3px]',
      )}
    >
      {items.map((item) => {
