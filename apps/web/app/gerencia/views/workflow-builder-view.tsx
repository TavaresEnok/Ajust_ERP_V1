      ...
      {activeTab === 'automacoes' && (
        <>
          ...
          <div className="flex flex-1 mt-4 mx-6 mb-6 gap-4 min-h-0">
            {/* Pipeline Canvas */}
            <div className="flex-1 bg-bg-surface rounded-xl border border-[rgba(0,0,0,0.06)] shadow-sm overflow-y-auto p-6">
              <div className="max-w-2xl mx-auto space-y-0">
                {/* TRIGGER BLOCK */}
                <div className="flex flex-col items-center">
                  <div className="w-full p-4 rounded-xl border-2 border-amber-200 bg-amber-50/40">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-2xs font-bold uppercase tracking-wider text-amber-600 bg-amber-100 px-2 py-0.5 rounded-full">
                            Trigger
                          </span>
                          <span className="text-2xs text-content-tertiary">Passo inicial</span>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <select
                            value={triggerType}
                            onChange={(e) => setTriggerType(normalizeTriggerType(e.target.value))}
                            className="px-2.5 py-1.5 text-xs border border-[rgba(0,0,0,0.08)] rounded-lg bg-white outline-none"
                          >
                            {TRIGGER_TYPES.map((t) => (
                          ...
                          <span className="text-2xs text-content-tertiary">com tipo =</span>
                          <select
                            value={triggerFilter}
                  ...
                  <div className="flex flex-col items-center py-2">
                    <ArrowDown className="w-5 h-5 text-content-tertiary" />
                  </div>
                </div>
                ...
                <div className="space-y-0">
                  {steps.map((step, idx) => (
                    <div key={step.id} className="flex flex-col items-center">
                      <div
                        ...
                        className={cn(
                          ...
                          selectedStepId === step.id
                            ? 'border-accent-DEFAULT bg-accent-subtle/30 shadow-md ring-2 ring-accent-DEFAULT/20'
                            : 'border-[rgba(0,0,0,0.08)] bg-bg-surface hover:border-[rgba(0,0,0,0.16)] hover:shadow-sm',
                        )}
                      >
                        <div className="flex items-start gap-3">
                          {/* Step number */}
                          <div
                            className={cn(
                              ...
                              getActionColor(step.action) === 'blue'
                                ? 'bg-blue-100 text-blue-600'
                                : getActionColor(step.action) === 'green'
                                  ? 'bg-green-100 text-green-600'
                                  : getActionColor(step.action) === 'amber'
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <span
                                className={cn(
                                  'inline-flex items-center gap-1 text-2xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full',
                                  getActionColor(step.action) === 'blue'
                              ...
                              <span className="text-2xs text-content-tertiary">
                                Passo {step.order} de {steps.length}
                              </span>
                            </div>
                            <input
                              value={step.title}
                              ...
                              className="text-base font-semibold text-content-primary bg-transparent border-none outline-none w-full p-0 -ml-0.5"
                            />
                      ...
                      {idx < steps.length - 1 && (
                        <div className="flex flex-col items-center py-2">
                          <div className="w-px h-6 bg-[rgba(0,0,0,0.12)]" />
                          <div className="w-6 h-6 rounded-full bg-bg-subtle border border-[rgba(0,0,0,0.08)] flex items-center justify-center">
                            <ArrowDown className="w-3 h-3 text-content-tertiary" />
                          </div>
                          <div className="w-px h-3 bg-[rgba(0,0,0,0.12)]" />
                        </div>
                      )}
                    </div>
                  ))}
                ...
                <div className="flex flex-col items-center pt-4 pb-6">
                  <div className="flex flex-col items-center">
                    <div className="w-6 h-6 rounded-full bg-bg-subtle border border-dashed border-[rgba(0,0,0,0.2)] flex items-center justify-center mb-2">
                      <ArrowDown className="w-3 h-3 text-content-tertiary" />
                    </div>
                    <button
                      onClick={addStep}
                      className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-accent-DEFAULT hover:text-white bg-accent-subtle hover:bg-accent-DEFAULT rounded-lg transition-all border border-dashed border-accent-DEFAULT/40"
                    >
                      <Plus className="w-4 h-4" />
                      Adicionar Passo
                    </button>
                ...
                {/* END block */}
                <div className="flex flex-col items-center">
                  <div className="w-6 h-6 rounded-full bg-bg-subtle border border-[rgba(0,0,0,0.08)] flex items-center justify-center mb-2">
                    <ArrowDown className="w-3 h-3 text-content-tertiary" />
                  </div>
                  <div className="w-full p-4 rounded-xl border-2 border-dashed border-[rgba(0,0,0,0.12)] bg-bg-subtle/50 text-center">
                    ...
                    <p className="text-2xs text-content-tertiary mt-1">
                      A trilha de O.S. será encerrada após o último passo
                    </p>
                  </div>
                </div>
              </div>
