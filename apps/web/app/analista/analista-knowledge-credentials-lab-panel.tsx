        ...
        >
          <div
            className={cn(
              ...
              dark ? 'border-slate-700/50 text-slate-200' : 'border-slate-100 text-slate-800',
            )}
          >
          ...
          {selected && (
            <div className="space-y-3">
              <div className="flex items-start justify-between gap-2">
                <div>
                  <div
                    className={cn('text-xs uppercase', dark ? 'text-slate-500' : 'text-slate-500')}
                  >
                    Detalhes
                  </div>
              ...
              <div
                className={cn(
                  ...
                  dark ? 'border-slate-700/50 bg-[#0f172a]/80' : 'border-slate-200 bg-slate-50',
                )}
              >
              ...
              >
                ...
                <div
                  className={cn(
                    'text-sm whitespace-pre-wrap break-words max-h-[36vh] overflow-y-auto custom-scrollbar pr-1',
                    dark ? 'text-slate-300' : 'text-slate-700',
                  )}
                >
